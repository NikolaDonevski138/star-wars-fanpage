...
export const ShopList = () => {
  ...
  const { setShopCategory } = useSwapiShop((state) => ({
  ...
  return (
    <div className={style.shopListContainer}>
      <ShopCategory
        ...
        shopItemCategory="T-Shirt"
        image={tShirtCategoryImg}
        onClick={() => onClickCategory("T-Shirt")}
      />
      <ShopCategory
        key={2}
        className="hover-zoom"
        shopItemCategory="Hoodie"
        image={hoodieCategoryImg}
        onClick={() => onClickCategory("Hoodie")}
      />
      <ShopCategory
        key={3}
        className="hover-zoom"
        shopItemCategory="Pendants"
        image={pendatsCategoryImg}
        onClick={() => onClickCategory("Pendants")}
      />
      <ShopCategory
        key={4}
        className="hover-zoom"
        shopItemCategory="Hats"
        image={hatCategoryImg}
        onClick={() => onClickCategory("Hats")}
      />
      <ShopCategory
        key={5}
        className="hover-zoom"
        shopItemCategory="Toys"
        image={toysCategoryImg}
        onClick={() => onClickCategory("Toys")}
      />
    </div>
  );
};
